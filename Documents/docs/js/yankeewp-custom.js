...
(function ($) {
    ...
    jQuery(document).ready(function() {
        ...
        jQuery(".mt_slider_members").owlCarousel({
            navigation: false,
            pagination: false,
            autoPlay: false,
            slideSpeed: 700,
        ...
        jQuery(".mt_slider_members .owl-wrapper .owl-item:nth-child(2)").addClass("hover_class");
        jQuery(".mt_slider_members .owl-wrapper .owl-item").hover(
            function() {
                jQuery(".mt_slider_members .owl-wrapper .owl-item").removeClass("hover_class");
