...
class InvestorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("dashboard.investor",compact("investor","blogs","user_invites","project_fundings","recentblogs","recentmsgs","organizations","orders"));
    }
    ...
    public function store(Request $request)
    {
        //print_r($request->all()); exit();
         ...
         DB::table('investors')->insert(['expertise' => $request->expertise,'category' => $request->category,'country_interest' => $request->country,'roi' => $request->roi,'capital_invesment' => $request->capital_invesment,'women_stage' => $request->women_stage,'expectation' => $request->expect,'created_by' => $userid,'updated_by' => $userid]);
    ...
    public function update(Request $request, $id)
    {
        //print_r($request->all()); exit();
         ...
         DB::table('investors')->where('id',$id)->update(['expertise' => $request->expertise,'category' => $request->category,'country_interest' => $request->country,'roi' => $request->roi,'capital_invesment' => $request->capital_invesment,'women_stage' => $request->women_stage,'expectation' => $request->expect,'updated_by' => $userid]);
         return redirect('/investor')->with('message', 'Investor Details Added Successfully');
    }
