...
class SupporterController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view('admin.supporter.index',compact('mydetails'));
    }
    ...
    ['firstname' => $request->firstname, 'lastname' => $request->lastname, 'username' => $request->username, 'password' => $password, 'email' => $request->email, 'phone' => $request->phone, 'groupid' => $gid ]
        ...
        return redirect('/admin/supporter'); 
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.supporter.show',compact('mydetail'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.supporter.edit',compact('mydetails'));
    }
