...
a.opt.mouseover.call(a,null)})},_buildScoreField:function(){return e("<input />",{name:this.opt.scoreName,type:"hidden"}).appendTo(this)},_createCancel:function(){var a=this.opt.path+this.opt.cancelOff,b=e("<"+this.opt.starType+" />",{title:this.opt.cancelHint,"class":this.opt.cancelClass});this.opt.starType==="img"?b.attr({src:a,alt:"x"}):b.attr("data-alt","x").addClass(a);this.opt.cancelPlace==="left"?this.self.prepend("Â ").prepend(b):this.self.append("Â ").append(b);this.cancel=b},_createScore:function(){var a=
e(this.opt.targetScore);this.score=a.length?a:c._buildScoreField.call(this)},_createStars:function(){for(var a=1;a<=this.opt.number;a++){var b=c._nameForIndex.call(this,a);b={alt:a,src:this.opt.path+this.opt[b]};if(this.opt.starType!=="img")b={"data-alt":a,"class":b.src};b.title=c._getHint.call(this,a);e("<"+this.opt.starType+" />",b).appendTo(this);if(this.opt.space)this.self.append(a<this.opt.number?"Â ":"")}this.stars=this.self.children(this.opt.starType)},_error:function(a){e(this).text(a);
