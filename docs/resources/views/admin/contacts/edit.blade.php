            ...
            <div class="widget widget-default">
                ...
                <form action="{{url('/admin')}}/contacts/update" method="post">
                    {{csrf_field()}} 
                        ...
                        <input type="text" name="subject" id="subject" class="form-control" value="{{$mydetails[0]->subject}}">
                        <p class="help-block">Enter your last name.</p>

                        <label for="username">Message *</label>
                        <textarea name="message" id="message" class="form-control">{{$mydetails[0]->message}}</textarea>
                        <p class="help-block">Enter the message.</p>
