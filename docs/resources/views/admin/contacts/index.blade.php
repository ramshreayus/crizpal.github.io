    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- <div class="col-xs-12 col-md-3">
                <a href="{{url('/admin')}}/contacts/create" type="button" class="btn btn-primary btn-xl btn-faded pull-right visible-lg visible-md"><span class="fa fa-paint-brush"></span> Create New</a>
            </div> -->
        </div>
    </div>
</header>
            ...
            <tbody>
               @foreach ($mydetails as $mydetail)
                <tr>
                    ...
                    <td class="text-right">
                        <!-- <a href="{{url('/admin')}}/contacts/edit/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
                            <span class="fa fa-pencil"></span>
                            <span class="hidden-xs hidden-sm">Edit</span>
                        </a> -->
                        <a href="{{url('/admin')}}/contacts/delete/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-transparent-danger btn-xs">
                            <span class="fa fa-trash"></span> 
                            <span class="hidden-xs hidden-sm">Delete</span>
                        </a>
                        <a href="{{url('/admin')}}/contacts/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
