    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-3">
                <a href="{{url('/admin')}}/entrepreneur/create" type="button" class="btn btn-primary btn-xl btn-faded pull-right visible-lg visible-md"><span class="fa fa-paint-brush"></span> Create New</a>
            </div>
        </div>
    </div>
</header>
        ...
        <table class="table table-condensed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left">
                        <a href="{{url('/admin')}}/entrepreneur/hide/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
                    ...
                    <td class="text-left">
                        ...
                        <a href="{{url('/admin')}}/entrepreneur/unhide/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
                            <span class="fa fa-times"></span>
                            <span class="hidden-xs hidden-sm">No</span>
                        </a>
                    </td>
                    ...
                    <td class="text-right">
                        <a href="{{url('/admin')}}/entrepreneur/edit/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
                            <span class="fa fa-pencil"></span>
                            <span class="hidden-xs hidden-sm">Edit</span>
                        </a>
                        <a href="{{url('/admin')}}/entrepreneur/delete/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-transparent-danger btn-xs">
                            <span class="fa fa-trash"></span> 
                            <span class="hidden-xs hidden-sm">Delete</span>
                        </a>
                        <a href="{{url('/admin')}}/entrepreneur/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
