...
<div class="row">
        <div class="col-md-12">
            <div class="widget widget-default">
                ...
                <form action="{{url('/admin')}}/entrepreneur_market/update" method="post" enctype="multipart/form-data">
                    {{csrf_field()}} 
                    ...
                    @endif
                        ...
                        <input type="text" name="market" id="market" class="form-control" value="{{$mydetails[0]->market_size}}">
                        <p class="help-block">Enter your Market.</p>

                        <label for="market_size">Market Size *</label>
                        <input type="text" name="market_size" id="market_size" class="form-control" value="{{$mydetails[0]->market_size}}">
                        <p class="help-block">Enter your Market size.</p>

                        <label for="growth_rate">Annual Growth Rate *</label>
                        <input type="text" name="growth_rate" id="growth_rate" class="form-control" value="{{$mydetails[0]->growth_rate}}">
                        <p class="help-block">Enter your Growth Rate.</p>
