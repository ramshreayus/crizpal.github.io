    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-md-9">
                <h1 class="page-header-heading"><span class="typcn typcn-home page-header-heading-icon"></span> Donations </h1>
        ...
        <table class="table table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="hidden-xs hidden-sm">Supporter Name</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="hidden-xs hidden-sm">Donation</td>
