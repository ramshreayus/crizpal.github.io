<header class="top-header">
    <a href="{{url('/')}}" title="Go To Main Page" class="top-header-logo">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right" data-dropdown-in="flipInX" data-dropdown-out="zoomOut">
                    <li class="hidden-sm hidden-xs hidden-md"><a href="{{url('/')}}" title="Go To Main Page">Welcome to <strong>Africa Innovation </strong>Market.</a></li>
                    ...
                    <li><a href="{{url('/admin')}}/logout"><span class="fa fa-sign-out"></span> <span class="hidden-sm hidden-xs">Log out</span></a></li>
                  </ul>
        </div>
    </nav>
</header>  