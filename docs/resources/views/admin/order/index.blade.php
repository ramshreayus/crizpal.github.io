        ...
        <table class="table table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="hidden-xs hidden-sm">Ordered By</th>
            ...
            <tbody>
                ...
                <tr>
                    <?php $pname = DB::table('products')->where('id',$mydetail->product_id)->get(); ?>
                    <td class="hidden-xs hidden-sm">{{$mydetail->id}}</td>
                    <td class="hidden-xs hidden-sm">{{$pname[0]->name}}</td>
                    <td class="hidden-xs hidden-sm">{{$mydetail->qty}}</td>
