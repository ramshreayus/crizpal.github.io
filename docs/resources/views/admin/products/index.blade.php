        ...
        <table class="table table-condensed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="hidden-xs hidden-sm">{{$mydetail->short_desc}}</td>
                    <td class="hidden-xs hidden-sm">{{$mydetail->description}}</td>
                                    
                    <td class="text-right">
                        <a href="{{url('/admin')}}/products/edit/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
                            <span class="fa fa-pencil"></span>
                            <span class="hidden-xs hidden-sm">Edit</span>
                        </a>
                        <a href="{{url('/admin')}}/products/delete/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-transparent-danger btn-xs">
                            <span class="fa fa-trash"></span> 
                            <span class="hidden-xs hidden-sm">Delete</span>
                        </a>
                        <a href="{{url('/admin')}}/products/{{$mydetail->id}}" class="btn btn-faded btn-transparent btn-xs">
