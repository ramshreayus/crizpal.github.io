    ...
    <div class="col-lg-12">
        <table class="table table-condensed">
            <tbody>
                ...
                <tr>
                    <td class="hidden-xs hidden-sm">Area of Interest</td>
                    <td class="hidden-xs hidden-sm">{{$mydetail[0]->area_interest}}<</td>
                </tr>
                 <tr>
                    <td class="hidden-xs hidden-sm">Country of Interest</td>
