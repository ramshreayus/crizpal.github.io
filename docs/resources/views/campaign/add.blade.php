     ...
     <div class="resp-tab">
      <div class="row ">  
              ...
              <div class="resp-tabs-container hor_1 clearfix"> 
                    ...
                    <form class="" action="{{url('/')}}/campaign/store" method="post" enctype="multipart/form-data">
                                {{csrf_field()}} 
                                <div class="form-group">
                                    <label >Title <span class="acf-required">*</span></label>                               
                                    <input name="title" value="" size="40" class="form-control" type="text">
                                </div>
                                <div class="form-group">
                                    <label >Goal <span class="acf-required">*</span></label>                               
                                    <input name="goal" value="" size="40" class="form-control" type="text">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="terms" cols="40" rows="10" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label >Start Date <span class="acf-required">*</span></label>                               
                                    <input name="startdate" value="" size="40" class="form-control" type="date">
                                </div>
                                <div class="form-group">
                                    <label >End Date <span class="acf-required">*</span></label>                               
                                    <input name="todate" value="" size="40" class="form-control" type="date">
                                </div>
