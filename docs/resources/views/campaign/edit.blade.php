     ...
     <div class="resp-tab">
      <div class="row ">  
              ...
              <div class="resp-tabs-container hor_1 clearfix"> 
                    ...
                    <form class="" action="{{url('/')}}/campaign/{{$campaign[0]->id}}/update" method="post" enctype="multipart/form-data">
                                {{csrf_field()}} 
                                <div class="form-group">
                                    <label >Title <span class="acf-required">*</span></label>                               
                                    <input name="title" value="{{$campaign[0]->title}}" size="40" class="form-control" type="text">
                                </div>
                                <div class="form-group">
                                    <label >Goal <span class="acf-required">*</span></label>                               
                                    <input name="goal" value="{{$campaign[0]->goal}}" size="40" class="form-control" type="text">
                                </div>
                                <div class="form-group">
                                    <label >About <span class="acf-required">*</span></label>                             
                                    <textarea name="content" cols="40" rows="10" class="form-control">{{$campaign[0]->about}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label >Terms & Conditions <span class="acf-required">*</span></label>                             
                                    <textarea name="terms" cols="40" rows="10" class="form-control">{{$campaign[0]->terms}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label >Start Date <span class="acf-required">*</span></label>                               
                                    <input name="startdate" value="{{$campaign[0]->startdate}}" size="40" class="form-control" type="date">
                                </div>
                                <div class="form-group">
                                    <label >End Date <span class="acf-required">*</span></label>                               
                                    <input name="todate" value="{{$campaign[0]->todate}}" size="40" class="form-control" type="date">
                                </div>
