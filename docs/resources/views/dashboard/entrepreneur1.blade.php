                    ...
                    <div id="verticalTab" class="v-tabs">
                        ...
                        <div class="resp-tabs-container">              
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="state" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="country" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <li> <label> <input type="radio" value="Others" name="gender"/> Others</label> </li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Women Stage  <span class="acf-required">*</span> <i class="fa fa-question-circle" ></i></label>
                                                            <input name="women_stage" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="website" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">LinkedIn URL   <span class="acf-required">*</span> <i class="fa fa-question-circle" ></i></label>
                                                            <input name="linked_url" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="tw_url" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Facebook URL  <span class="acf-required">*</span> <i class="fa fa-question-circle" ></i></label>
                                                            <input name="fb_url" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="blog_url" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Google+ URL  <span class="acf-required">*</span> <i class="fa fa-question-circle" ></i></label>
                                                            <input name="gp_url" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <ul>
                                                            <li> <label> <input type="checkbox" value="Diaspora" name="category"/> Diaspora</label> </li>
                                                            <li> <label> <input type="checkbox" value="Social Entrepreneur" name="category"/> Social Entrepreneur</label> </li>
                                                            <li> <label> <input type="checkbox" value="Uncategorized" name="category"/> Uncategorized</label> </li>
                                                            <li> <label> <input type="checkbox" value="Women" name="category"/> Women</label> </li>
                                                            <li> <label> <input type="checkbox" value="Youth" name="category"/> Youth</label> </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>  
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="p_yr_revenue" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Current Year Revenue  <i class="fa fa-question-circle" ></i></label>
                                                            <input name="c_yr_revenue" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="n_yr_revenue" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Founded Date  <i class="fa fa-question-circle" ></i></label>
                                                            <input name="founded_date" id="friend_name-0" value="" class="form-control"  type="date">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <div class="business-plan">
                                                                Upload a business plan you already have or <a href="#"></a><span> Download the business plan template </span>, fill it out to best of your ability, and upload.
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="no_employee" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <input name="filepath" id="friend_name-0" value="" class="btn"  type="file">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="filetitle" id="friend_name-0" value="" class="form-control"  type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="fileurl" id="friend_name-0" value="" class="form-control"  type="text">
                                                                    </div>
                                                                </div>
                                                                <!-- <div class="acf-form-submit">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <div class="repeater-cust"> 
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="market" id="friend_name-0" value="" class="form-control"  type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="market_size" id="friend_name-0" value="" class="form-control"  type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="growth_rate" id="friend_name-0" value="" class="form-control"  type="text">
                                                                    </div>
                                                                </div><!-- 
                                                                <div class="acf-form-submit">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                            ...
                                                            <div class="repeater-cust"> 
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-lg-9 col-xs-12">  
                                                                        <input name="position" id="friend_name-0" value="" class="form-control"  type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">  
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="goal" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Fund Raised So Far <i class="fa fa-question-circle" ></i></label>
                                                            <input name="fund_for" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="fund_pvt" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="pre_money" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Interest / Dividend <i class="fa fa-question-circle" ></i></label>
                                                            <input name="interest" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            ...
                                                            <input name="prev_fund" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                            <label style="display: block;">Funding Commitments <i class="fa fa-question-circle" ></i></label>
                                                            <input name="fund_commitment" id="friend_name-0" value="" class="form-control"  type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row refer refer-body">
                                                        <div class="refer-col">
                                                            <div class="col-md-4 col-sm-4 col-inputs">
                                                                <input name="name1" id="friend_name-0" value="" class="form-control" placeholder="Name" type="text">
                                                            </div>      
                                                            <div class="col-md-4 col-sm-4 col-inputs">
                                                                <input name="email1" id="friend_email-0" value="" class="form-control" placeholder="Email" type="email">
                                                            </div>      
                                                            <div class="col-md-4 col-sm-4 col-inputs">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="idea" class="form-control"  type="text"></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Women Model  <i class="fa fa-question-circle" ></i></label>
                                                    <textarea name="women_model" class="form-control"  type="text"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="customer" class="form-control"  type="text"></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Market  <i class="fa fa-question-circle" ></i></label>
                                                    <textarea name="market" class="form-control"  type="text"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="industry" class="form-control"  type="text"></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Product  <i class="fa fa-question-circle" ></i></label>
                                                    <textarea name="product" class="form-control"  type="text"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="campaign" class="form-control"  type="text"></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Budget  <i class="fa fa-question-circle" ></i></label>
                                                    <textarea name="budget" class="form-control"  type="text"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    ...
                                                    <textarea name="team" class="form-control"  type="text"></textarea>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                                    <label style="display: block;">Your Pitch  <i class="fa fa-question-circle" ></i></label>
                                                    <textarea name="pitch" class="form-control"  type="text"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="{{url('/blog')}}/1/edit" class="btn btn-sm btn-primary">Edit</a></td>
                                        </tr>                
                                    </tbody>
                                    <tfoot></tfoot>
                                </table>
                            ...
                            <div><!-- Orders -->
                                ...
                                <a href="https://africainnovationmarket.org/my-account/view-order/4845">
                                #4845                               </a>

                                </td>
                                <td class="order-date" data-title="Date">
                                <time datetime="2018-09-19" title="1537379002">September 19, 2018</time>
                                ...
                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>300.00</span> for 1 item
                                </td>
                                <td class="order-actions" data-title="&nbsp;">
                                <a href="{{url('/order')}}/1" class="button view">View</a>                                                    </td>
                                </tr>
                                </tbody>
                                </table>
                            </div>
...
<script type="text/javascript">
        ...
        function add_invite()
        {
            ...
            viewhtml += '<input name="name'+add_count+'" id="friend_name-0" value="" class="form-control" placeholder="Name" type="text">';
            viewhtml += '</div> ';     
            viewhtml += '<div class="col-md-4 col-sm-4 col-inputs">';
            viewhtml += '<input name="email'+add_count+'" id="friend_email-0" value="" class="form-control" placeholder="Email" type="email">';
            viewhtml += '</div> ';     
            viewhtml += '<div class="col-md-4 col-sm-4 col-inputs">';
            viewhtml += '<select name="groupid'+add_count+'" class="form-control">';
