                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="dashboard-tile detail tile-purple">
                                                <div class="content" style="padding-right:100px;">
                                                    <div class="text-left "  style="font-size:30px;">$<span class="timer" data-to="100" data-speed="2500"></span></div>
                                ...
                                <img src="{{url('/')}}/assets_new/images/support-profile-update.png" alt="" /> -->
                                                <form id="post" class="" @if(count($investor) > 0) action="{{url('/')}}/investor/{{$investor[0]->id}}/update" @else action="{{url('/')}}/investor/store" @endif method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="expertise" cols="40" rows="10" class="form-control" required="">@if(count($investor) > 0) {{$investor[0]->expertise}} @endif</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label > Investment Capital  <span class="acf-required">*</span></label>                              
                                                        <input name="capital_invesment" @if(count($investor) > 0) value="{{$investor[0]->capital_invesment}}" @else value="" @endif size="40" class="form-control" type="text" required="">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <ul class="acf-checkbox-list acf-bl">
                                                            ...
                                                            <li><label class="selectit"><input name="category" value="{{$category->id}}" type="radio" @if(count($investor) > 0) @if($investor[0]->category == $category->id) checked="" @endif @endif > {{$category->name}}</label></li>@endif 
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="roi" @if(count($investor) > 0) value="{{$investor[0]->roi}}" @else value="" @endif size="40" class="form-control" type="text" required="">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="expect" cols="40" rows="10" class="form-control" required="">@if(count($investor) > 0) {{$investor[0]->expectation}} @endif</textarea>
                                                    </div>
