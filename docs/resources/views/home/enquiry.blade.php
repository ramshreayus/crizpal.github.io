            ...
            <div class="panel">
              <aside class="panel-body">
                <ul class="nav nav-pills nav-stacked compose-nav">
                      ...
                      <li class="active"> <a href="{{url('/enquiry')}}"> <i class="fa fa-star-o"></i> Enquiries</a> </li>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form id="messageform" action="/messages/store" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}   
              ...
              <br /><br />
              <button class="btn btn-primary" id="sendmessagebtn" ><span>Send Message</span></button>
            </form>
          </div>
        </div>
      </div>
