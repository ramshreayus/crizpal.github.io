<header class="top-header">
    <a href="{{url('/')}}/assets/index.html" class="top-header-logo">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right" data-dropdown-in="flipInX" data-dropdown-out="zoomOut">
                    <li class="hidden-sm hidden-xs hidden-md"><a href="#">Welcome to <strong>Africa Innovation </strong>Market.</a></li>
                    ...
                    <li><a href="{{url('/')}}/assets/log-in.html"><span class="fa fa-sign-out"></span> <span class="hidden-sm hidden-xs">Log out</span></a></li>
                  </ul>
        </div>
    </nav>
</header>  