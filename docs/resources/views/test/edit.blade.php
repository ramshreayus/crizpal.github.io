            ...
            <div class="widget widget-default">
                ...
                <form action="{{url('/')}}/test/update" method="post">
                    {{csrf_field()}} 
                        ...
                        <input type="text" name="username" id="username" class="form-control" value="{{$users[0]->name}}">
                        <p class="help-block">Enter the username you registered with.</p>
                        <label for="password">Email *</label>
                        <input type="email" name="email" id="email" class="form-control" value="{{$users[0]->email}}" >
                        <p class="help-block">And your personal Email.</p>
                        <label for="password">Phone *</label>
                        <input type="number" name="phone" id="phone" class="form-control" value="{{$users[0]->phone}}" >
